...
| InspectorAppUserID | Numeric                   | 18                   | Yes                   | No                       | Yes                      | Foreign key referencing the staff member performing the inspection.  | None              | Must match an existing Staff ID    |
...
| ManagerAppUserID          | Numeric                   | 18                   | Yes                   | No                       | Yes                      | Foreign key referencing the manager overseeing the inspection.       | None              | Must match an existing Staff ID    |
| Notes              | Multi-Line Text           | Unlimited            | Yes                   | No                       | No                       | Additional notes or details about the inspection.                    | None              | None                               |
| WhenCompleted      | Date Time                 | N/A                  | Yes                   | No                       | No                       | Date and time when the inspection was completed.                     | None              | None                               |
...
- **Foreign Key Indexes**:
  ...
  - `ManagerAppUserID` (to optimize joins with manager-related queries).
...
| MakeYear        | Numeric                   | 4                    | Yes                   | No                       | No                       | Manufacturing year of the car.                                 | None              | Must be a valid year value         |
...
| BodyColor       | Single Line of Text       | 50                   | Yes                   | No                       | No                       | Body color of the car.                                         | None              | None                               |
| InteriorColor   | Single Line of Text       | 9                    | Yes                   | No                       | No                       | Interior color of the car.                                     | None              | None                               |
| LicensePlate    | Single Line of Text       | 255                  | Yes                   | No                       | No                       | License plate or tag number for the car.                       | None              | None                               |
...
| EntraID         | Single Line of Text       | 32                   | Yes                   | No                       | No                       | Entra ID for tracking (could be used for forieng keys) purposes. | User().EntraObjectID | None                            |
| EmployeeID      | Single Line of Text       | 32                   | Yes                   | No                       | No                       | Employee identifier for HR or payroll systems.                   | None                 | Must be unique                  |
| Photo           | Image                     | (binary)             | Yes                   | No                       | No                       | M365 profile photo                                               | None                 | None                            |
...
| PIN             | Single Line of Text       | 50                   | Yes                   | No                       | No                       | Personal Identification Number for user authentication.          | None                 | At least 4 digits or characters |
